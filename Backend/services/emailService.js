   ...
   <tr>
    <td align="center" bgcolor="#003366" style="border-radius:4px;">
     <a href="${url}" target="_blank"
       style="display:inline-block;padding:14px 36px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.025em;border-radius:4px;background:#003366;">
      ${label}
     </a>
    </td>
   </tr>
  ...
  <tr>
   <td align="center" style="padding:40px 16px;">
    ...
    <table role="presentation" class="email-container" width="600" cellpadding="0" cellspacing="0" border="0"
     ...
     <!-- ═══ HEADER ═══ -->
     <tr>
      <td class="email-header" align="center" style="background:linear-gradient(135deg,#001a33 0%,#003366 55%,#005599 100%);padding:36px 40px 32px;text-align:center;">
       <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto 16px auto;">
        <tr>
         <td valign="middle" style="padding-right:10px;">
          <img src="${APP_URL()}/ai_logo.png" alt="Logo" width="40" height="40" style="display:block;width:40px;height:40px;object-fit:contain;filter:brightness(0) invert(1);" />
         </td>
         <td valign="middle">
