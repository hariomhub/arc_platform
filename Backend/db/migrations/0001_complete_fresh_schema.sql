-- Migration: 0001_complete_fresh_schema
-- Description: Complete baseline schema for ARC Platform (racdbp)
-- Created: 2026-05-23
-- Author: System
...
CREATE TABLE IF NOT EXISTS membership_applications (
  ...
  INDEX idx_ma_requested_role (requested_role),
...
SELECT 'Migration 0001: Complete fresh schema applied.' AS result;
