...
export const uploadEventThumbnail = (id, formData) =>
    api.post(`/events/${id}/upload-thumbnail`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
    });

export const uploadSpeakerPhoto = (id, formData) =>
    api.post(`/events/${id}/upload-speaker-photo`, formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
    });
