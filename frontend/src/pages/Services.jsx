...
import {
    ShieldCheck, Users, ArrowRight, CheckCircle,
    Award, BookOpen, Globe,
} from 'lucide-react';
...
const WHY_ITEMS = [
    {
        ...
        desc: 'Our product assessments are unbiased and written by vetted industry practitioners, not vendors.',
    },
    {
        icon: BookOpen,
        title: 'Self-Service Playbooks',
        desc: 'We provide ready-to-use governance templates and guides. No expensive consultants needed.',
    },
    {
        icon: Users,
        title: 'Expert Network',
        desc: 'Access to a global council of 500+ AI risk professionals across 40 countries.',
    },
    {
        icon: ShieldCheck,
        title: 'Framework Aligned',
        desc: 'All our resources are mapped to EU AI Act, NIST AI RMF, ISO 42001, and sector-specific requirements.',
    },
];
    ...
    return (
        <>
            ...
            >
                ...
                <div style={{ position: 'absolute', bottom: '-80px', left: '-80px', width: '320px', height: '320px', borderRadius: '50%', background: 'rgba(255,255,255,0.02)' }} />
                <div className="container" style={{ maxWidth: '750px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                    ...
                    <p style={{ fontSize: '1.15rem', color: '#CBD5E1', lineHeight: '1.7', marginBottom: '0' }}>
            ...
            <div style={{ background: '#F8FAFC', padding: '3rem 2rem' }}>
                <div className="container" style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                        <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#1A202C', marginBottom: '0.5rem' }}>
                            What We Offer
                        </h2>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(440px, 1fr))', gap: '2rem' }}>
                        ...
                        >
                            ...
                            <div style={{ padding: '2.25rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem', display: 'flex', flexDirection: 'column', gap: '0.6rem', flex: 1 }}>
                                    {[
                                        'Hands-on feature testing with scored results',
                                        'Evidence-backed capability assessments',
                                        'Vendor-neutral, unbiased analysis',
                                        'User community ratings and feedback',
                                    ].map((f) => (
                                        <li key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', fontSize: '0.875rem', color: '#475569' }}>
                                            <CheckCircle size={15} color="#003366" style={{ flexShrink: 0, marginTop: '2px' }} />
                                            {f}
                                        </li>
                                    ))}
                                </ul>
                                ...
                                <button
                                    onClick={() => navigate('/services/product-reviews')}
                                    style={{
                                        display: 'inline-flex', alignItems: 'center', gap: '8px',
                        ...
                        <div
                            ...
                            onMouseOver={(e) => { e.currentTarget.style.boxShadow = '0 12px 32px rgba(124,58,237,0.12)'; e.currentTarget.style.transform = 'translateY(-4px)'; }}
                            onMouseOut={(e) => { e.currentTarget.style.boxShadow = '0 4px 16px rgba(0,0,0,0.06)'; e.currentTarget.style.transform = 'translateY(0)'; }}
                        >
                            ...
                            <div style={{ padding: '2.25rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                ...
                                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem', display: 'flex', flexDirection: 'column', gap: '0.6rem', flex: 1 }}>
                                    {[
                                        'Governance fundamentals and risk appetite design',
                                        'AI crisis tabletop simulation exercises',
                                        'RAI controls, testing and validation deep dive',
                                        'Regulatory horizon scanning and briefings',
                                    ].map((f) => (
                                        <li key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', fontSize: '0.875rem', color: '#475569' }}>
                                            <CheckCircle size={15} color="#7C3AED" style={{ flexShrink: 0, marginTop: '2px' }} />
                                            {f}
                                        </li>
                                    ))}
                                </ul>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '1.75rem' }}>
                        {WHY_ITEMS.map(({ icon: Icon, title, desc }) => (
                            <div
                                ...
                                onMouseOver={(e) => { e.currentTarget.style.boxShadow = '0 8px 24px rgba(0,51,102,0.08)'; e.currentTarget.style.transform = 'translateY(-3px)'; }}
                                onMouseOut={(e) => { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.transform = 'translateY(0)'; }}
                            >
                                <div style={{
                                    width: '44px', height: '44px', borderRadius: '10px',
                                    background: '#EBF0F7', marginBottom: '1rem',
            ...
            {/* ── CTA Banner ───────────────────────────────────────────────── */}
            <div style={{ background: 'linear-gradient(135deg, #003366 0%, #005599 100%)', padding: '5rem 2rem', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                border: '2px solid rgba(255,255,255,0.5)', padding: '0.9rem 2rem',
